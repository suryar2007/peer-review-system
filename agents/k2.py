    ...
    def verify_claim(
        ...
        try:
            ...
            system = (
                ...
                "- If the source directly contradicts the claim, mark it 'contradicted'.\n"
                "- If the source clearly supports the claim, mark it 'supported'.\n"
                "- If you cannot determine the relationship, mark it 'unverifiable'.\n\n"
